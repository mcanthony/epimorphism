{
 ...
 'sources': ['util', 'math', 'colorspace', '__epimorphism', 'epi_cull', 'epi_reduce', 'epi_reset', 'epi_color', 'epi_seed_c', 'epi_seed_a', 'epi_seed_wt', 'epi_seed_w', '__epi_seed', '__epi_kernels'], 
 'kernel': 'epimorphism',
 'lib_prefix': 'epi',
