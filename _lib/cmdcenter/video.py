...
class VideoRenderer(object):
    ...
    def capture(self):
        ...
        def grab_image():
            ...
            if(self.app.max_video_frames and self.frame_num == int(self.app.max_video_frames)):
                ...
                if(hasattr(self.app, 'video_script')):
    ...
    def stop_video(self, compress=False):
        ...
        def compress():
            ...
            cmd = "./ffmpeg -f image2 -r 30 -i media/video/%s/%05d.png -c:v libx264 -pix_fmt yuv420p -crf 20 -threads 7 %s.mp4" % (self.video_name, self.video_name)
