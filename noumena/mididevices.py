...
BCF_LIVE = [{(0, 83): ["state.zn",  '0',  "radius", (1.0, 1.0)],
            ...
            {(0, 83): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_DHUE")',  "val",    (1.0, 0.0)],
             ...
             (0, 85): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_R")',  "val",    (1.0, 0.0)],
             (0, 86): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_I")',  "val",    (1.0, 0.0)],
             (0, 87): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PHI1")',  "val",    (1.0, 0.0)],
             (0, 88): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PHI1")',  "val",    (1.0, 0.0)],
             ...
             (0, 7) : ["state.par", 'self.cmdcenter.state.par_names.index("_SEED_W_MIN")', "val",    (0.6, 0.0)],
             (0, 8) : ["state.par", 'self.cmdcenter.state.par_names.index("_SEED_W_MAX")', "val",    (1.0, 0.0)]
             }
