...
BCF_LIVE = [{(0, 83): ["state.zn",  '0',  "radius", (1.0, 1.0)],
             ...
             (0, 85): ["state.zn",  '5',  "radius", (1.0, 0.0)],
             (0, 86): ["state.zn",  '9',  "radius", (1.0, 0.0)],
             (0, 87): ["state.zn",  '10', "radius", (1.0, 1.0)],
             (0, 88): ["state.zn",  '11', "radius", (1.0, 0.0)],
             (0, 1) : ["state.par", 'self.cmdcenter.state.par_names.index("_SEED_W")',  "val",    (1.0, 0.0)],
             (0, 2) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PHI1")',  "val",    (1.0, 0.0)],
             (0, 3) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PSI1")',  "val",    (1.0, 0.0)],
             ...
             (0, 7) : ["state.par", 'self.cmdcenter.state.par_names.index("_SEED_W_MIN")',  "val",    (0.5, 0.0)],
...
BCF_VJ   = [{(0, 83): ["state.zn",  '0',  "radius", (1.0, 1.0)],
            ...
            {(0, 83): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_DHUE")',  "val",    (1.0, 0.0)],
             ...
             (0, 85): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_I")',  "val",    (1.0, 0.0)],
             (0, 86): ["state.par", 'self.cmdcenter.state.par_names.index("_HSLS_RESET_Z")',  "val",    (1.0, 0.0)],
             (0, 87): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_LEN_SC")',  "val",    (1.0, 0.0)],
             (0, 88): ["state.par", 'self.cmdcenter.state.par_names.index("_HSLS_RESET_Z")',  "val",    (1.0, 0.0)],
             (0, 1) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PHI1")',  "val",    (1.0, 0.0)],
             (0, 2) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PSI1")',  "val",    (1.0, 0.0)],
             (0, 3) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PHI2")',  "val",    (1.0, 0.0)],
             (0, 4) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_PSI2")',  "val",    (1.0, 0.0)],
             (0, 5) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_PHI")',  "val",    (1.0, 0.0)],
             (0, 6) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_PSI")',  "val",    (1.0, 0.0)],
             (0, 7) : ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_KILL")', "val",    (1.0, 0.0)],
             },
