...
BCF_LIVE = [{(0, 81): ["state.zn",  '0',  "radius", (1.0, 1.0)],
            ...
            {(0, 83): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_DHUE")',  "val",    (1.0, 0.0)],
             ...
             (0, 86): ["state.par", 'self.cmdcenter.state.par_names.index("_COLOR_BASE_R")',  "val",    (1.0, 0.0)],
            ...
            {(0, 81): ["state.zn",  '0',  "radius", (1.0, 1.0)],
             (0, 82): ["state.zn",  '1',  "radius", (1.0, 0.0)],
             (0, 83): ["state.zn",  '2',  "radius", (1.0, 1.0)],
             (0, 84): ["state.zn",  '3',  "radius", (1.0, 0.0)],
             (0, 85): ["state.zn",  '8',  "radius", (1.0, 1.0)],
             ...
             (0, 87): ["state.zn",  '10', "radius", (1.0, 1.0)],
             (0, 88): ["state.zn",  '11', "radius", (1.0, 0.0)],
             (0, 1) : ["state.zn",  '0',  "th",     (3.14, 0.0)],
             (0, 2) : ["state.zn",  '1',  "th",     (3.14, 0.0)],
             (0, 3) : ["state.zn",  '2',  "th",     (3.14, 0.0)],
             (0, 4) : ["state.zn",  '3',  "th",     (3.14, 0.0)],
             (0, 5) : ["state.zn",  '8',  "th",     (3.14, 0.0)],
             (0, 6) : ["state.zn",  '9',  "th",     (3.14, 0.0)],
             (0, 7) : ["state.zn",  '10', "th",     (3.14, 0.0)],
             (0, 8) : ["state.zn",  '11', "th",     (3.14, 0.0)]}
             ]
